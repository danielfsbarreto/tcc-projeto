...
\begin{table}[H]
	...
	\multirow{2}{*}{\textbf{Atividades}} & \multicolumn{2}{c |}{\textbf{2013}} & \multicolumn{3}{c |}{\textbf{2014}} \\ \cline{2-6}
		...
		E3. Fundamentação teórica (métodos ágeis, lean, adoção ágil, etc.) & & \cellcolor{black!100} & & & \\ \cline{1-1}
		...
		E9. Análise geral do trabalho e identificação de trabalhos futuros & & & & & \cellcolor{black!100} \\ \hline
	\end{tabular}
\end{table}
