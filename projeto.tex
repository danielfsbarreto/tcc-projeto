...
\begin{table}[H]
	...
	\multirow{2}{*}{\textbf{Atividades}} & \multicolumn{2}{c |}{\textbf{2013}} & \multicolumn{3}{c |}{\textbf{2014}} \\ \cline{2-6}
		...
		\hhline{------}
		E1. Estudo exploratório sobre desenvolvimento ágil para identificação do objetivo do trabalho & \cellcolor{black!100} & & & & \\ \cline{1-1}
		E2. Elaboração das questões de pesquisa & \cellcolor{black!100} & & & & \\ \cline{1-1}
		E3. Assimilação da fundamentação teórica (métodos ágeis, lean, adoção ágil, etc.) & & \cellcolor{black!100} & & & \\ \cline{1-1}
		E4. Investigação de desafios e lições aprendidas  a partir de publicações científicas & & & \cellcolor{black!100} & & \\ \cline{1-1}
		E5. Investigação de desafios e lições aprendidas  a partir de relatos de experiência & & & \cellcolor{black!100} & & \\ \cline{1-1}
		E6. Consolidação dos resultados obtidos das revisões, análise de similaridades e categorização & & & \cellcolor{black!100} & & \\ \cline{1-1}
		E7. Questionário e entrevistas com especialistas e empresas & & & & \cellcolor{black!100} & \\ \cline{1-1}
		E8. Protótipo de um repositório de lições aprendidas & & & & \cellcolor{black!100} & \\ \cline{1-1}
		E9. Análise geral do trabalho e identificação de trabalhos futuros & & & & \cellcolor{black!100} & \\ \cline{1-1}
		Apresentação à banca & & & & & \cellcolor{black!100} \\ \hline
	\end{tabular}
\end{table}
